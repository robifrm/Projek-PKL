    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/dashboard/**").hasAnyRole("SUPER_ADMIN", "STAFF")
                .requestMatchers(HttpMethod.GET, "/api/customers/**").hasAnyRole("SUPER_ADMIN", "STAFF")
                .requestMatchers(HttpMethod.POST, "/api/customers/**").hasAnyRole("SUPER_ADMIN", "STAFF")
                .requestMatchers(HttpMethod.PUT, "/api/customers/*/status").hasAnyRole("SUPER_ADMIN", "STAFF")
                .requestMatchers(HttpMethod.DELETE, "/api/customers/**").hasRole("SUPER_ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/packages/**").hasAnyRole("SUPER_ADMIN", "STAFF")
