    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/packages/**").hasAnyRole("SUPER_ADMIN", "STAFF", "AGENT")
                ...
                .requestMatchers("/api/users/profile", "/api/users/change-password", "/api/users/sessions", "/api/users/sessions/**").hasAnyRole("SUPER_ADMIN", "STAFF", "AGENT")
